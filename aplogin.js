...
function receiveditemsListener(items, index) {
...
function connectedListener(packet) {
...
function bouncedListener(packet) {
  if (packet) {
    if (packet.data) {
...
function disconnectedListener(packet) {
  window.is_connected = false;
...
let classaddtext = ['...', '!!', '!', '!!!', '@#!', '!?!', '@!!', '?!@']
let classadddesc = ['Item class: normal', 'Item class: progression', 'Item class: useful', 'Item class: progression, useful', 'Item class: trap', 'Item class: progression, trap', 'Item class: useful, trap', 'progression, useful, trap']
let classothercolors = [
  'rgba(100, 149, 237, 1)',
  'rgba(0, 255, 127, 1)',
  'rgba(238, 0, 238, 1)',
  'rgba(250, 250, 210, 1)',
...
if (shapeParam) {
  ...
  if (shapeSelect) {
    const index = Number.parseInt(shapeParam, 10) - 1;
